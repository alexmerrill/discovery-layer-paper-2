...
#$path1 = "C:\path\to\paperTitlesInPrimo_noFacets.csv"
#$path1 = "C:\path\to\paperTitlesInPrimo_noRefnoNewsnoReview.csv"
#$path1 = "C:\path\to\paperTitlesInPrimo_booksOnly.csv"
#$path1 = "C:\path\to\paperTitlesInPrimo_articlesOnly.csv"
...
#$date = "&qInclude=facet_searchcreationdate,exact,%5B1000%2BTO%2B2021%5D"
